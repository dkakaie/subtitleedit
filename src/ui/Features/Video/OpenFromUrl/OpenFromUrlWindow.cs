...
public class OpenFromUrlWindow : Window
{
    ...
    public OpenFromUrlWindow(OpenFromUrlViewModel vm)
    {
        ...
        var downloadVideoCheckBox = new CheckBox
        {
            Content = Se.Language.Video.OpenFromUrlDownloadVideo,
            HorizontalAlignment = HorizontalAlignment.Left,
            Margin = new Thickness(0, 4, 0, 0),
            [!CheckBox.IsCheckedProperty] = new Binding(nameof(vm.DownloadVideo)) { Mode = BindingMode.TwoWay },
        };
        ...
        var includeAutoGeneratedCheckBox = new CheckBox
        {
            Content = Se.Language.Video.OpenFromUrlIncludeAutoGeneratedSubtitles,
            HorizontalAlignment = HorizontalAlignment.Left,
            Margin = new Thickness(24, 0, 0, 4),
            [!CheckBox.IsCheckedProperty] = new Binding(nameof(vm.IncludeAutoGeneratedSubtitles)) { Mode = BindingMode.TwoWay },
            [!Control.IsEnabledProperty] = new Binding(nameof(vm.DownloadSubtitles)),
        };
